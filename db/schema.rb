...
ActiveRecord::Schema.define(version: 20140203200636) do
  ...
  add_index "deathstare_upstream_sessions", ["client_device_id", "end_point_id"], name: "upstream_sessions_client_device", unique: true, using: :btree
  add_index "deathstare_upstream_sessions", ["email", "end_point_id"], name: "index_deathstare_upstream_sessions_on_email_and_end_point_id", unique: true, using: :btree
  ...
  add_index "deathstare_upstream_sessions", ["username", "end_point_id"], name: "index_deathstare_upstream_sessions_on_username_and_end_point_id", unique: true, using: :btree
